...
public class TinyDB {
     ...
     */
    public ArrayList<Float> getListDouble(String key) {
        String[] myList = TextUtils.split(preferences.getString(key, ""), "‚‗‚");
        ArrayList<String> arrayToList = new ArrayList<String>(Arrays.asList(myList));
   ...
   public <T> T getObject(String key, Class<T> classOfT){
     ...
     */
    public void putListDouble(String key, ArrayList<Float> doubleList) {
        checkForNullKey(key);
        Float[] myDoubleList = doubleList.toArray(new Float[doubleList.size()]);
    ...
    public void putListObject(String key, ArrayList<Entidad> objArray){
    	checkForNullKey(key);
    	Gson gson = new Gson();
    	ArrayList<String> objStrings = new ArrayList<String>();
    	for(Entidad obj : objArray){
